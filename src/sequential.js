...
function handleJsonSeq(data) {
    ...
    var legend_text = '<h4><span i18n="' + (selected_values["map_type"] == "sg" ? selected_values["justice"] : selected_values["v1"]) + '"></span> [<span i18n="' + data.features[0].properties.value_desc + '"></span>]'+ (selected_values["justice"] == "acc" ? , <span i18n="' + selected_values["mot"] + '"></span>' : '') + '</h4>';
